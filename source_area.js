...
function dar_baja_2(id) {
    ...
    $(document).ready(function () {
        ...
        $.post("dar_baja_area.php",
            { item: item },
            function (data) {
                pone_lista_usuarios()
                $("#lista_scaneo6").html(data);
                alertify.error('El area fue dado de BAJA correctamente.');
            });
    });
...
function modificar_datos() {
    ...
    $.post("modificar_datos_area.php",
        {nombre: nombre, departamento: departamento, codigo:codigo },
        function (data) {
            pone_lista_usuarios()
            $("#lista_scaneo6").html(data);
...
function registrar_datos() {
    ...
    if (bandera === true) {
        $.post("registrar_datos_area.php",
            { codigo: codigo, nombre: nombre, departamento: departamento },
            function (data) {
                alertify.success('El area se registró correctamente.');
