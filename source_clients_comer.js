...
function lista_vendedores() {
  ...
  //   fec_fin = $("#fechaf").val();
  //   sed = $("#sed select").val()
  //   cardcode = $("#lista_clients select").val();
  //   vendedor = $("#pone_vendedores select").val();
  
  //   $.ajax({
  //     beforeSend: function () {
  //       $("#lista_Repor_Consumo").html("Recuperando Lista ...");
  //     },
    ...
    $(document).ready(function () {
      if ($("#fechai").val() != "" || $("#fechaf").val() != "") {
        $.ajax({
          ...
          url: 'Listar_Report_Facturas_Emitidas_comer.php',
          type: 'POST',
    ...
    $(document).ready(function () {
      if ($("#fechai").val() != "" || $("#fechaf").val() != "") {
        ...
        $.ajax({
          ...
          url: 'Listar_Report_Facturas_Emitidas_Load_comer.php',
          type: 'POST',
          data: 'fechai=' + fech +
            '&fechaf=' + fech +
            // '&sed=' + 1 +
