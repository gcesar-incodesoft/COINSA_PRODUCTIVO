...
function procesa_Busqueda() {
  ...
  /////traer datos 
  $.post("Lista_Datos_marca_proveedor.php", { proveedor: proveedor, fabricante: fabricante, fechai: fechai, fechaf: fechaf, txt: txt },
    function (dat2) {
  ...
  $(document).ready(function () {
    if ($("#fechai").val() != "" || $("#fechaf").val() != "") {
      $.ajax({
        ...
        url: 'Listar_Report_Facturas_EmitidasCompras2.php',
        type: 'POST',
...
function exportar_excel_merca_comprobantes() {

  javascript: window.open(
    "reporte_excel_compras_exterior.php?&fechai=" +
    $("#fechai").val() +
    "&fechaf=" +
    $("#fechaf").val() +
    "&sed=" +
...
function exportar_excel_merca_articulos() {
  proveedor = $("#lista_proveedores option:selected").val();
  fabricante = $("#lista_Fabricantes option:selected").val();
  //subfami = $("#lista_SubFamilia option:selected").val();
  fechai = $("#fechai2").val();
  ...
  javascript: window.open(
    "reporte_excel_compras_exterior_art.php?&proveedor=" +
    proveedor +
    "&fabricante=" +
    fabricante +
    "&fechai=" +
