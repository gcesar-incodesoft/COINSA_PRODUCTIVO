...
function procesa_Busqueda() {
  ...
  /////traer datos 
  $.post("Lista_Datos_marca_proveedor_nac.php", { proveedor: proveedor, fabricante: fabricante, fechai: fechai, fechaf: fechaf, txt: txt },
    function (dat2) {
  ...
  $(document).ready(function () {
    if ($("#fechai").val() != "" || $("#fechaf").val() != "") {
      $.ajax({
        ...
        url: 'Listar_Report_Facturas_EmitidasCompras_nac.php',
        type: 'POST',
...
function exportar_excel_merca_nac_comproba() {

  javascript: window.open(
    "reporte_excel_compras_nacional.php?&fechai=" +
    $("#fechai").val() +
    "&fechaf=" +
    $("#fechaf").val() +
    "&sed=" +
...
function exportar_excel_merca_nac_arti() {

  javascript: window.open(
    "reporte_excel_compras_nacional_art.php?&proveedor=" +
    proveedor +
    "&fabricante=" +
    fabricante +
    "&fechai=" +
