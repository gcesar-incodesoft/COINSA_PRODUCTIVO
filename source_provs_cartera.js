...
function lista_tipo_cuenta() {
  ...
  $(document).ready(function () {
    $.ajax({
      beforeSend: function () {
        // $("#pone_tipos").html("Recuperando proveedores...");
      },
      url: 'pone_tipo_cuenta.php',
      type: 'POST',
      data: null,
      success: function (x) {
        $("#pone_tipos").html(x);
...
function busca_cuentas_proveedor() {
  $(document).ready(function () {
    $.ajax({
      ...
      url: 'consulta_cuenta_proveedores.php',
      type: 'POST',
      data: 'idcliente=' + $("#cliente").val() + '&idtipo=' + $("#tipo").val(),
      success: function (x) {
...
function busca_cuentas_vendedores() {
  $(document).ready(function () {
    $.ajax({
      ...
      type: 'POST',
      data: 'idcliente=' + $("#cliente").val() + '&idmes=' + $("#cmeses").val(),
      success: function (x) {
...
function exportarExcel() {
  ...
  pone_clientes = $("#pone_clientes option:selected").val();

  //alert('reporte_despacho_detallado_excel.php?fi='+fi+'&ff='+ff+'&pone_cliente='+pone_cliente+'');
  javascript: window.open('rep_cuentasxpagar_proveedores_excel.php?pone_clientes=' + pone_clientes + '');
}
