...
function busca_resumen_compras() {
    ...
    setTimeout(() => {
        ...
        if (bandera === true) {
            $(document).ready(function () {
                ...
                $.ajax({
                    beforeSend: function () {
                        // $("#lista_top_compras").html("Consultando informacion...");
                        swal({
                            title: "Cargando...",
                    ...
                    url: 'consulta_topCompras.php',
                    type: 'POST',
                    data: 'idmes=' + $("#cmeses").val() + '&anio=' + $("#anio").val(),
                    success: function (x) {
                        // Retrasar el cierre del Swal 1.5 segundos
                        setTimeout(() => {
                            swal.close();
                            $("#lista_top_compras").html(x);
                    ...
                    error: function (jqXHR, estado, error) {
                        $("#lista_top_compras").html(estado + "    " + error);
                    }
                });
            });
        }
...
function exportar_excel_top_compras() {

    javascript: window.open(
        "reporte_excel_top_compras.php?&idmes=" +
        $("#cmeses").val() +
        "&anio=" +
        $("#anio").val() +
        ""
