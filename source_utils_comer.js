    ...
    $(document).ready(function () {
      if ($("#fechai").val() != "" || $("#fechaf").val() != "") {
        $.ajax({
          ...
          url: 'busca_ventas_despacho_comer.php',
          type: 'POST',
    ...
    $(document).ready(function () {
      if ($("#fechai").val() != "" || $("#fechaf").val() != "") {
        $.ajax({
          ...
          url: 'busca_ventas_pedidospendientes_comer.php',
          type: 'POST',
          data: 'fechai=' + $("#fechai").val() + '&fechaf=' + $("#fechaf").val() + '&cliente=' + $("#cliente").val() + '&vendedor=17',
          success: function (res) {
            swal.close();
